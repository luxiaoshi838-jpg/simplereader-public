...
class V13InteractionContractTest {
    ...
    fun `bookmark creation stays in reader top bar with source vector and page uniqueness`() {
        ...
        assertTrue(vector.contains("M16,2.5 C8.54,2.5"))
        assertTrue(vector.contains("M10.5,8 L21.5,8"))
        assertTrue(vector.contains("M16,11.2 L16,16.2 M13.5,13.7 L18.5,13.7"))
