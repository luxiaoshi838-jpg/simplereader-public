...
android {
    ...
    val generatedVersionCode = (System.getenv("SIMPLE_READER_VERSION_CODE") ?: "2098000613")
        .toIntOrNull()
        ?: 2098000613
    val generatedVersionName = System.getenv("SIMPLE_READER_VERSION_NAME") ?: "613"
...
dependencies {
    ...
    implementation("org.readium.kotlin-toolkit:readium-shared:2.4.1")
    implementation("org.readium.kotlin-toolkit:readium-streamer:2.4.1")
    implementation("org.readium.kotlin-toolkit:readium-navigator:2.4.1")
