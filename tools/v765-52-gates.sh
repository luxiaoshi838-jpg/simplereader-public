...
cd "$ROOT"
TMP="$(mktemp tools/v765-52-generated.XXXXXX.sh)"
LEGACY_GATE17="tools/v749-17-gates.sh"
LEGACY_GATE19="tools/v750-19-gates.sh"
BACKUP17="$(mktemp tools/v749-17-gates.v765-backup.XXXXXX.sh)"
BACKUP19="$(mktemp tools/v750-19-gates.v765-backup.XXXXXX.sh)"
...
source = source.replace('2098000759', '2098000765')
source = source.replace("'\\\"759\\\"'", "'\\\"765\\\"'")
source = source.replace('v759', 'v765')
