...
source = source.replace('2098000757', '2098000768')
source = source.replace("'\"757\"'", "'\"768\"'")
source = source.replace('v757/rule113 versions missing', 'v768/rule115 versions missing')
source = source.replace('v757 version + catalog rule113', 'v768 version + catalog rule115')
...
if old_checkpoint not in source:
    raise SystemExit('V768 gate adaptation failed: V757 checkpoint assertion not found')
...
if old_anchor not in source:
    raise SystemExit('V768 gate adaptation failed: V757 fallback anchor assertion not found')
