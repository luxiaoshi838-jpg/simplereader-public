...
cd "$ROOT"
TMP="$(mktemp tools/v766-52-generated.XXXXXX.sh)"
LEGACY_GATE17="tools/v749-17-gates.sh"
LEGACY_GATE19="tools/v750-19-gates.sh"
BACKUP17="$(mktemp tools/v749-17-gates.v766-backup.XXXXXX.sh)"
BACKUP19="$(mktemp tools/v750-19-gates.v766-backup.XXXXXX.sh)"
...
source = source.replace('2098000759', '2098000766')
source = source.replace("'\\\"759\\\"'", "'\\\"766\\\"'")
source = source.replace('v759', 'v766')
