...
source = source.replace('2098000757', '2098000770')
source = source.replace("'\"757\"'", "'\"770\"'")
source = source.replace('v757/rule113 versions missing', 'v770/rule115 versions missing')
source = source.replace('v757 version + catalog rule113', 'v770 version + catalog rule115')
